...
const routes: Routes = [
  ...
  { 
    path: "precision_manufacturing", 
    canActivate: [DashboardGuard],
    component: ProgramCorteComponent,
    children: [{
                path: "", component: PackingBudgetComponent, outlet: "home"
              }]
  },
  ...
  { 
    ...
    component: DashboardComponent, 
    children: [{
                path: "", component: ManageUsersComponent, outlet: "home"
              }]
  },
  ...
  { 
    ...
    component: DashboardComponent, 
    children: [{
                path: "", component: AuditoryComponent, outlet: "home"
              }]
  },
  ...
  { 
    ...
    component: DashboardComponent, 
    children: [{
                path: "", component: ReportsComponent, outlet: "home"
              }]
  },
